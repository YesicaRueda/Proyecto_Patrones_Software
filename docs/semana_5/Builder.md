# Semana V - Aplicación del patrón Builder
...
| **Prototype**      | Pendiente    | Por evaluar/implementar según necesidad real en el sistema. |
...
Con este avance, el proyecto cuenta con cuatro patrones de diseño implementados:
...
Con los patrones Singleton, Factory Method, Abstract Factory y Builder implementados y probados (19 pruebas automatizadas en total), el proyecto cuenta con una base organizada, reutilizable y escalable para continuar incorporando los módulos y patrones pendientes del sistema.

---

# 24. Correcciones y cambios generales
